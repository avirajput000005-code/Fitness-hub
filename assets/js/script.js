...
// ============================================
// DYNAMIC NAVBAR LOGGED-IN STATE
// ============================================
    ...
    if (session) {
        try {
            ...
            if (navLogin && navRegister) {
                ...
                navLogin.innerHTML = `<a class="nav-link" href="pages/dashboard.html"><i class="fas fa-chart-line"></i> Dashboard</a>`;
                
                // Change Sign Up to Logout
                navRegister.innerHTML = `<a class="nav-link btn-register" href="javascript:void(0)" onclick="handleHomeLogout()"><i class="fas fa-sign-out-alt"></i> Logout</a>`;
            }
        } catch (e) {
            console.error('Error parsing session on homepage:', e);
        }
    }
}
